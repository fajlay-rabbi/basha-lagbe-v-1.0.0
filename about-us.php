...
<body>
    <div class="container">
        ...
        <div class="wrapper">
            ...
            <h5 class="title">আমাদের সম্পর্কে</h5>
            <hr>
            ...
            <p class="mb-5">আমাদের লক্ষ্য হল আপনাদের সুবিধায় এবং আপনার প্রয়োজনে সমর্থক হতে সাহায্য করা। আপনি একটি বাসা অনুসন্ধান করতে বা আপনার বাসা ভাড়া দেওয়ার জন্য এখানে সাইন আপ করতে পারেন এবং সহজেই তাদের সাথে যোগাযোগ করতে পারেন।</p>



            <h5 class="title">আমাদের লক্ষ্য</h5>
            <hr>
            <p class="mb-5">আমরা ব্যক্তিগত, সুরক্ষিত এবং সাহায্যকর অভিজ্ঞান প্রদান করতে দৃঢ়ভাবে মোতিব। আমরা মানুষদের একে অপরকে বোঝার জন্য এবং সহজেই অভিজ্ঞান অংশগ্রহণ করার জন্য একটি সামাজিক প্ল্যাটফর্ম তৈরি করতে চাই।</p>



            <h5 class="title">কেন আমাদের?</h5>
            <hr>
            ...
            <h4 class="mb-5 fw-bold text-center mt-5 text-info">আমাদের সাথে থাকার জন্য ধন্যবাদ!</h4>
